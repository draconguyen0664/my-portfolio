...
function createWrappedTexture(originalTexture) {
...
function TexturedSphere({ exitTrigger, onExitComplete }) {
  const [tex1, tex2] = useLoader(TextureLoader, [
    "/texture.png",
    "/texture-services.png",
  ]);
