      ...
      <div className="container">
        <div className="footer__wrapper">
          ...
          <div className="footer__social">
            <a href="#" target="_blank" className="link-line">
              instagram
              <svg
          ...
          <div className="footer-behance">
            <AnimatedLink text="dribbble" to="#" target="_blank" />
            <AnimatedLink text="behance" to="#" target="_blank" />
            <AnimatedLink text="linkedin" to="#" target="_blank" />
          </div>
